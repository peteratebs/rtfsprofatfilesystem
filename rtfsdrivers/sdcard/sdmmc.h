...
#define SD_RESP_R0   0      /* No response expected */
#define SD_RESP_R1   1      /* 48 bit response expected */
#define SD_RESP_R1b  2      /* 48 bit response expected, monitor busy */
#define SD_RESP_R2   3      /* 136 bit CSD CID */
#define SD_RESP_R3   4      /* 48 bit OCR */
#define SD_RESP_R6   5      /* 48 bit RCA */
#define SD_RESP_R7   6      /* 48 card card intervace condition */
