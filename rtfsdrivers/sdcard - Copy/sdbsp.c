...
/******************************************************************************
** Function name:        RtSdBSP_Controller_Init
**
** Descriptions: Called once at startup, initialize the controller, hook interrupts etc
**
** parameters:
** Returned value:
**
...
// FC== CLK/4 FD == CLK, FE == CLK/2 FF=CLK/8
    ...
    PINMODE2 |= 0x280A8A0;         /* MCI/SD Pins have neither pull-up nor pull down resistor, the value is 00000010100000001010100010100000 */

    SCS |= 0x08;                 /* 3 corresponds to MCIPWR 0 the MCIPWR pin is low. 1 The MCIPWR pin is high */
