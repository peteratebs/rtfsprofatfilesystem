...
EXRAM static DDRIVE          			__mem_drive_pool[RTFS_CFG_MAX_DRIVES];
EXRAM static RTFS_DEVI_MEDIA_PARMS 	__rtfs_mediaparms[RTFS_CFG_MAX_DRIVES];
EXRAM static BLKBUFF         			__mem_block_pool[RTFS_CFG_MAX_SCRATCH_BUFFERS];
EXRAM static byte            			__mem_block_data[RTFS_CFG_MAX_SCRATCH_BUFFERS*RTFS_CFG_DEFAULT_SECTOR_SIZE_BYTES];
EXRAM static PC_FILE         			__mem_file_pool[RTFS_CFG_MAX_FILES];
EXRAM static DROBJ           			__mem_drobj_pool[RTFS_CALCULATED_DIRS];
EXRAM static FINODE          			__mem_finode_pool[RTFS_CALCULATED_DIRS];
EXRAM static RTFS_SYSTEM_USER 		__rtfs_user_table[RTFS_CFG_MAX_USER_CONTEXTS];
EXRAM static void *					__rtfs_user_cwd_pool[RTFS_CFG_MAX_USER_CONTEXTS*RTFS_CFG_MAX_DRIVES];
EXRAM static REGION_FRAGMENT 			__mem_region_pool[RTFS_CFG_MAX_REGION_BUFFERS];
